...
#define TSS_HCS08_MCU                          1      /* Macro defines MCU platform */

#define TSS_MCU_SUBFAMILY_HCS08PT              1      /* Macro defines MCU subfamily */

#define TSS_TSI_VERSION                        0      /* Macro defines TSI version */
#define TSS_TSIL_VERSION                       1      /* Macro defines TSIL version */
...
#define TSS_USE_BASELINE_INIT_DURATION         10     /* Baseline initialization duration */
...
#define TSS_E0_TYPE                 TSI_CH4           /* Electrode measurement method specification */
#define TSS_E1_TYPE                 TSI_CH5           /* Electrode measurement method specification */
#define TSS_E2_TYPE                 TSI_CH6           /* Electrode measurement method specification */
#define TSS_E3_TYPE                 TSI_CH7           /* Electrode measurement method specification */
#define TSS_E4_TYPE                 TSI_CH3           /* Electrode measurement method specification */
#define TSS_E5_TYPE                 TSI_CH2           /* Electrode measurement method specification */
#define TSS_E6_TYPE                 TSI_CH1           /* Electrode measurement method specification */
#define TSS_E7_TYPE                 TSI_CH0           /* Electrode measurement method specification */
...
#define TSS_C0_INPUTS               {0,1,2,3,4,5,6,7} /* Electrodes assigned to the control */
